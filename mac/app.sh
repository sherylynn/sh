...
#normal app
brew cask install onyx skim iina firefox chromium calibre v2rayx qq wechat anydesk teamviewer visual-studio-code telegram-desktop steam gimp squirrel visual-studio-code libreoffice virtualbox openshot-video-editor emacs
#macx86 app
