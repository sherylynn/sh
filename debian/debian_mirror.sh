...
if [[ $1 = "" ]]; then
    ...
    sudo vi /etc/apt/sources.list '+%s#\[signed-by="/usr/share/keyrings/debian-archive-keyring.gpg"\]##g' 
else
    echo "edit $1"
    ...
    sudo vi $1 '+%s#\[signed-by="/usr/share/keyrings/debian-archive-keyring.gpg"\]##g' 
fi
