...
sed 's/${USER}/git/g' $HOME/gogs_data/gogs/conf/app.ini
sed 's/home/data/g' $HOME/gogs_data/gogs/conf/app.ini
sed '46c ROOT_PATH = /app/gogs/log' $HOME/gogs_data/gogs/conf/app.ini  
fi
