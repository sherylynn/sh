...
sudo $busybox chroot $DEBIANPATH /bin/su - lynn -c 'export DISPLAY=:0 && export PULSE_SERVER=127.0.0.1 && dbus-launch --exit-with-session startxfce4'
