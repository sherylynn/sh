...
configure_debian_chroot() {
    ...
    sudo $busybox chroot $CHROOT_DIR /bin/su - root -c 'source /root/sh/win-git/toolsinit.sh && proxy && zsh /root/sh/win-git/noVNC.sh && zsh /root/sh/win-git/zlua_new.sh && zsh /root/sh/win-git/init_d_noVNC.sh'
