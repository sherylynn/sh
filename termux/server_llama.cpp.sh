...
#sudo /data/local/tmp/llama.cpp/build/bin/llama-server -m /sdcard/Download/DeepSeek-R1-Distill-Qwen-14B-abliterated-v2.Q4_0.gguf --host 0.0.0.0 --port 8888 -ngl 0 -t 8
